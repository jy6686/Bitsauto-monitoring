...
export const PLATFORM_FEATURE_FLAGS: FeatureFlagDefinition[] = [
  ...
  {
    key: 'explainability_timeline',
    label: 'Explainability: Incident Timeline',
    description: 'Surfaces the incident & lifecycle event timeline inside the explainability drawer for full_evidence roles.',
    ownerRole: 'admin',
    automationLevel: 'L1',
    defaultEnabled: true,
  },
  {
    key: 'explainability_blast_radius',
    label: 'Explainability: Blast Radius',
    description: 'Shows portfolio exposure KPI in the explainability drawer. Active for all explainability depths.',
    ownerRole: 'admin',
    automationLevel: 'L1',
    defaultEnabled: true,
  },
  {
    key: 'explainability_projection',
    label: 'Explainability: Projection Summary',
    description: 'Shows pre-computed advisory projection in the drawer for execution_impact and full_evidence roles.',
    ownerRole: 'admin',
    automationLevel: 'L1',
    defaultEnabled: true,
  },
  {
    key: 'explainability_external_visibility',
    label: 'Explainability: External Portal Visibility',
    description: 'Allows external portal roles to access any explainability data. OFF until portal hardening is complete (Stage 2F).',
    ownerRole: 'admin',
    automationLevel: 'L1',
