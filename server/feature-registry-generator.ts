  ...
  const children: Paragraph[] = [
    ...
    new Table({
      ...
      rows: [
        ...
        makeDataRow([{ text: 'Live Carrier Metrics Panel' }, { text: 'routing-intelligence.tsx (LiveMetricsPanel)' }, { text: '1' }, { text: 'REAL', color: GREEN }, { text: 'Real-time ASR/ACD/PDD/concurrent per carrier, 5/15/30/60min window — GET /api/routing-rules/metrics' }]),
    ...
    new Table({
      ...
      rows: [
        ...
        makeDataRow([{ text: 'SDP/Codec Negotiation Panel' }, { text: 'sip-trace.tsx (SdpPanel)' }, { text: '1' }, { text: 'REAL', color: GREEN }, { text: 'Codec offer/answer diff, negotiated pills, raw SDP accordion — GET /api/sippy/cdr/sdp' }], '131929'),
    ...
    new Table({
      ...
      rows: [
        ...
        makeDataRow([{ text: 'Carrier Quality Matrix' }, { text: 'test-campaigns.tsx (CarrierMatrixPanel)' }, { text: '1' }, { text: 'REAL', color: GREEN }], '131929'),
        makeDataRow([{ text: 'Tools Page' }, { text: 'tools.tsx' }, { text: '14' }, { text: 'REAL', color: GREEN }]),
        makeDataRow([{ text: 'API Keys' }, { text: 'api-keys.tsx' }, { text: '8' }, { text: 'REAL', color: GREEN }], '131929'),
        makeDataRow([{ text: 'Sidebar Menu Configuration' }, { text: 'sidebar-settings.tsx' }, { text: '3' }, { text: 'REAL', color: GREEN }]),
        makeDataRow([{ text: 'STIR/SHAKEN Monitor' }, { text: 'stir-shaken.tsx' }, { text: '—' }, { text: 'REAL', color: GREEN }], '131929'),
        makeDataRow([{ text: 'Call Recordings' }, { text: 'call-recordings.tsx' }, { text: '—' }, { text: 'REAL', color: GREEN }]),
    ...
    new Table({
      ...
      rows: [
        ...
        makeDataRow([{ text: '✅ Done', color: GREEN }, { text: 'Sidebar Menu Configuration' }, { text: '—' }, { text: 'Admin sidebar personalisation — /sidebar-settings, DB-backed, all-user visibility control' }]),
        makeDataRow([{ text: '✅ Done', color: GREEN }, { text: 'SDP/Codec Panel (SIP Trace)' }, { text: '—' }, { text: 'Codec offer/answer diff panel embedded in sip-trace.tsx, GET /api/sippy/cdr/sdp' }], '131929'),
        makeDataRow([{ text: '✅ Done', color: GREEN }, { text: 'Live Carrier Metrics (Routing Intel)' }, { text: '—' }, { text: 'Real-time ASR/ACD/PDD panel in routing-intelligence.tsx, GET /api/routing-rules/metrics' }]),
        makeDataRow([{ text: '✅ Done', color: GREEN }, { text: 'Carrier Quality Matrix (Campaigns)' }, { text: '—' }, { text: 'ITU E-model MOS letter grades in test-campaigns.tsx, GET /api/campaigns/carrier-matrix' }], '131929'),
