...
import BillingCertificationPage from "@/pages/billing-certification";
...
function Router() {
  return (
    <>
      ...
      <Route path="/commercial-live-calls">
        {() => <ProtectedRoute component={CommercialLiveCallsPage} requiredRoles={['admin','management','super_admin']} />}
      </Route>
      <Route path="/fraud">
      ...
      <Route path="/finance/certification">
        {() => <ProtectedRoute component={BillingCertificationPage} requiredRoles={['admin', 'management']} />}
      </Route>
      ...
      <Route path="/finance/company-profile">
        {() => <ProtectedRoute component={CompanyProfileWS} requiredRoles={['admin']} />}
      </Route>
      <Route path="/finance/business-partners">
        {() => <ProtectedRoute component={BusinessPartnersWS} requiredRoles={['admin', 'management']} />}
      </Route>
