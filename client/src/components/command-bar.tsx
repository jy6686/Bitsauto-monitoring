...
export const ROUTE_REGISTRY: RouteEntry[] = [
  ...
  { type: 'route', domain: 'Platform',             domainColor: 'text-slate-400',   label: 'Navigation Manager',   href: '/navigation-manager',   icon: Layers,          keywords: 'navigation manager enterprise control visibility' },
