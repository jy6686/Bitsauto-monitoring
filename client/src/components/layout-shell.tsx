...
const ROLE_BADGE: Record<Role, { label: string; color: string }> = {
  ...
  destination_manager: { label: "Dest. Manager",       color: "text-orange-400 bg-orange-500/10"   },
  routing_admin:       { label: "Routing Admin",       color: "text-teal-400 bg-teal-500/10"       },
...
export const SIDEBAR_GROUPS: NavGroup[] = [
  ...
  // ─── 3. Operations ───────────────────────────────────────────────────────────
  {
    ...
    items: [
      { href: "/vendors",                              label: "Vendor List",       icon: Building2,   roles: ['admin','management','super_admin','noc_operator','team_lead','destination_manager','routing_admin']  },
      { href: "/vendor-sla-scorecard",                 label: "SLA Scorecard",     icon: ShieldCheck, roles: ['admin','management','destination_manager','routing_admin']                                          },
      { href: "/carrier-scoring",                      label: "Carrier Scoring",   icon: BarChart3,   roles: ['admin','management','super_admin','noc_operator','team_lead','destination_manager'], isNew: true },
      { href: "/vendor-stability-timeline",            label: "Stability Timeline",icon: Activity,    roles: ['admin','management','destination_manager','routing_admin'], isNew: true                             },
      { href: "/balance",                              label: "Balance Monitor",   icon: Wallet,      roles: ['admin','management']                                          },
      { href: "/routing-manager",                      label: "Routing Manager",   icon: Database,    roles: ['admin','management','routing_admin'], hasSubmenu: 'routingmgr'               },
      { href: "/lcr-analyser",                         label: "LCR Analyser",      icon: GitBranch,   roles: ['admin','management','routing_admin']                                          },
      { href: "/call-flow-simulator",                  label: "Route Simulator",   icon: Workflow,    roles: ['admin','management']                                          },
      { href: "/self-heal",                            label: "Failover Engine",   icon: HeartPulse,  roles: ['admin','management','routing_admin'], isNew: true                             },
  ...
  // ─── 5. Intelligence ─────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { href: "/intelligence",               label: "Intelligence Hub",     icon: Brain,      roles: ['admin','management','destination_manager'], isNew: true },
      ...
      { href: "/intelligence-validation",    label: "Validation Console",   icon: FlaskConical, roles: ['admin','management','destination_manager'], isNew: true },
      { href: "/carrier-intelligence",       label: "Carrier Intelligence", icon: Activity,   roles: ['admin','management','super_admin','noc_operator','team_lead','destination_manager'], isNew: true },
      { href: "/vendor-rca",                 label: "Vendor RCA",           icon: ScanSearch, roles: ['admin','management','destination_manager'], isNew: true },
      { href: "/vendor-prefix-intelligence", label: "Prefix Intelligence",  icon: Globe,      roles: ['admin','management','destination_manager'], isNew: true },
      { href: "/routing-intelligence",       label: "Routing Intelligence", icon: Brain,      roles: ['admin','management','destination_manager','routing_admin'], isNew: true },
      { href: "/number-intelligence",        label: "Number Intelligence",  icon: ScanSearch, roles: ['admin','management']              },
      { href: "/cost-optimisation",          label: "Cost Optimisation",    icon: Lightbulb,  roles: ['admin','management','destination_manager']              },
      { href: "/route-optimisation",         label: "Route Optimisation",   icon: BrainCircuit,   roles: ['admin','management','super_admin','noc_operator','team_lead','destination_manager'], isNew: true },
      { href: "/traffic-steering",           label: "Traffic Steering",     icon: ArrowRightLeft, roles: ['admin','management','super_admin','noc_operator','team_lead','destination_manager'], isNew: true },
      { href: "/simulation-sandbox",         label: "Simulation Sandbox",   icon: FlaskConical,   roles: ['admin','management','super_admin','noc_operator','team_lead','destination_manager'], isNew: true },
    ],
  },
  // ─── 6. Security & Compliance ────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { href: "/approvals",            label: "Approval Queue", icon: ShieldCheck,   roles: ['admin','management','super_admin','noc_operator','team_lead','destination_manager','routing_admin'], status: 'live' },
      { href: "/approval-settings",    label: "Approval Rules", icon: SlidersHorizontal, roles: ['admin','management','destination_manager']         },
