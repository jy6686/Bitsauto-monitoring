  ...
  // ── 7. FINANCE ───────────────────────────────────────────────────────────────
  {
    ...
    groups: [
      { label: 'Invoicing & Billing', desc: 'Invoices, billing overview, credit and payment management', icon: FileText, items: [
        { href: '/finance-cockpit',   label: 'Finance Cockpit',  desc: 'Margin analysis & billing snapshot',  icon: LayoutDashboard },
        ...
        { href: '/invoice-schedules', label: 'Schedules',        desc: 'Automated billing cycle scheduling',  icon: History },
        ...
        { href: '/payment-reminders', label: 'Payment Reminders',desc: 'Dunning & reminder schedule',         icon: Bell },
      ...
      { label: 'Revenue Assurance', desc: 'DMR, reconciliation, AI assurance and margin intelligence', icon: Brain, items: [
        ...
        { href: '/rating-verification',    label: 'Rating Verification', desc: 'Verify Sippy rates vs rate cards', icon: ShieldCheck },
        { href: '/rating-snapshots',       label: 'Rating Snapshots',    desc: 'Point-in-time tariff snapshots', icon: History },
