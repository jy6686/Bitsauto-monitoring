...
import {
  ...
  RefreshCw, Calendar, User, Zap, CheckCheck, XCircle,
} from "lucide-react";
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Input
                  ...
                  onChange={e => { setForm(f => ({ ...f, periodStart: e.target.value })); setDmrGateError(null); setDmrAutoResults(null); }}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={e => { setForm(f => ({ ...f, periodEnd: e.target.value })); setDmrGateError(null); setDmrAutoResults(null); }}
                  readOnly={form.billingCycle !== "custom"}
                  className={form.billingCycle !== "custom" ? "opacity-60 cursor-default" : ""}
                />
              </div>
