...
const ROUTE_DOMAIN_MAP: [string, WorkspaceDomain][] = [
  ...
  ['/rate-editor',                'finance'],
  ['/invoices',                   'finance'],
  ['/invoice-jobs',               'finance'],
  ['/invoice-templates',          'finance'],
  ['/credit-notes',               'finance'],
  ['/credit-control',             'finance'],
  ['/margin-intelligence',        'finance'],
  ['/dmr',                        'finance'],
  ['/client-reconciliation',      'finance'],
  ['/carrier-reconciliation',     'finance'],
  ['/dispute-cases',              'finance'],
  ['/dispute-defense',            'finance'],
  ['/ai-assurance',               'finance'],
  ['/partner-profiles',           'finance'],
  // ── Security & Compliance ─────────────────────────────────────────────────
  ...
  ['/noc-dashboard',              'live-network'],
  ['/noc-incidents',             'live-network'],
  ['/route-intelligence',        'live-network'],
