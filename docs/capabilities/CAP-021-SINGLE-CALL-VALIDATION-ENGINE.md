...
| VAL-004 CLI | route tester CLI verification (origination-side only — CAP-023 §3) + `loadCliHealthSummary()` | CAP-023 terminating-side observation (O3 DID / O4 handset) + CLD transformation verification; VAL-023 spoken CLI confirmation (L5) |
